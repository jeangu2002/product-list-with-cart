  ...
  return (
    <>
      ...
      >
        ...
        <div>
          <h1 className="font-bold text-3xl capitalize">Order confirmed</h1>
          ...
          {Object.entries(cart).map(([key, value]) => {
            return (
              ...
              >
                ...
                <p className="font-semibold justify-self-end">{formatCurency(value.price * value.quantity)}</p>
              </div>
            );
          })}
        ...
        <button className="bg-(--cl-red) text-white p-2 w-full rounded-full capitalize" onClick={onNewOrder}>
          Start a new order
        </button>
      </div>
    </>
